...
public record PdfDimensions(float x, float y, float width, float height) {
    ...
    final static float PAGE_WIDTH = 595.28f;
    final static float PAGE_HEIGHT = 841.89f;
    final static float PAGE_WIDTH_MM = 210.1f;
    final static float PAGE_HEIGHT_MM = 297.1f;
    public final static float PAGE_WIDTH_FACTOR = PAGE_WIDTH / PAGE_WIDTH_MM;
    final static float PAGE_HEIGHT_FACTOR = PAGE_HEIGHT / PAGE_HEIGHT_MM;
